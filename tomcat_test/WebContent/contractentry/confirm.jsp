...
<table width="100%" height="400" border="0">
  <tr>
    <td align="center" valign="top">
      ...
      <form method="post" action="<%= contextPath%>/RequestSubmitServlet" name="changelist">
        <table class="contractWidth">
          <tr>
            <td class="normalFont" align="left"> 以下内容で確定いたします。よろしいでしょうか。 </td>
          </tr>
                        ...
                        <td class="tableTitleBgColor">
                          <table class="p100b0" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <th class="s_moji" align="center" width="10%">お客様ID</th>
                              <th class="tableLineColor" width="1" height="1"></th>
                              <th class="s_moji" align="center" width="10%">ご契約名義</th>
                              <th class="tableLineColor" width="1" height="1"></th>
                              <th class="s_moji" align="center" width="10%">電話番号</th>
                              <th class="tableLineColor" width="1" height="1"></th>
                              <th class="s_moji" align="center" width="12%">機種</th>
                              <th class="tableLineColor" width="1" height="1"></th>
                              <th class="s_moji" align="center" width="9%">ご契約月</th>
                              <th class="tableLineColor" width="1" height="1"></th>
                              <th class="s_moji" align="center" width="9%">ご契約満了月</th>
                              <th class="tableLineColor" width="1" height="1"></th>
                              ...
                              <td class="tableBgColor">
                                <table class="p100b0" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td class="s_moji" align="center" width="10%"><%= customerID %></td>
                                    <td class="tableLineColor" width="1" height="1"></td>
                                    <td class="s_moji" align="center" width="10%"><%= contractName %></td>
                                    <td class="tableLineColor" width="1" height="1"></td>
                                    <td class="s_moji" align="center" width="10%"><%= deviceTelNo %></td>
                                    <td class="tableLineColor" width="1" height="1"></td>
                                    <td class="s_moji" align="center" width="12%"><%= deviceName %></td>
                                    <td class="tableLineColor" width="1" height="1"></td>
                                    <td class="s_moji" align="center" width="9%"><%= startMonth %></td>
                                    <td class="tableLineColor" width="1" height="1"></td>
                                    <td class="s_moji" align="center" width="9%"><%= endMonth %></td>
                                    <td class="tableLineColor" width="1" height="1"></td>
