 ...
 * @author tanimura
 */
@WebServlet(name = "ModelChangeConfirmServlet", urlPatterns = { "/ModelChangeConfirmServlet" })
public class ModelChangeConfirmServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (customerID != null) {
                ...
                // 申込台数チェック
                if (tetheringYesNum + tetheringNoneNum != telNoList.size()) {
                    errMsg += "申込台数は解約対象の機器台数と一致している必要があります。<br/>";
                    checkNG = true;
                }
                ...
                if (checkNG) {
                    ...
                    // 確認画面を表示する
                    target = Defines.JSP_MODELCHANGE_CONFIRM;
                }
            }
        }
        catch (Exception e) {
